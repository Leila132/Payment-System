...
class PaymentService:
    ...
    def create_payment(payment_data, user):
        ...
        resp = requests.post(f'{SANDBOX_URL}/api/v1/payments', json=payload, headers=headers)
    ...
    def get_payments_list(payment_data, user):
        if not check_date(payment_data.get("date_start")) or not check_date(payment_data.get("date_end")):
        ...
        resp = requests.get(f'{SANDBOX_URL}/api/v1/payments', params=params, headers=headers)
